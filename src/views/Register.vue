<template>
    <div id="registered">
        ...
        <van-field name="avatar" left-icon="smile-o" label="头像">
        <template #input>
        ...
        <div id="date_time_picker">
            ...
            <van-field v-model="birth_time" name="birth_time" placeholder="选择的日期" readonly />
        </div>

        <van-field name="gender" left-icon="closed-eye" label="性别">
            <template #input>
...
export default {
    ...
    methods: {
        ...
        onSubmit(values) {
            this.axios.post('/api/v1/registered', {
                data: values
            })
            .then(resp => {
                if (resp.data.code == 200){
                    ...
                    setTimeout(this.router_login, 3000);
                } else{
                    Toast({
